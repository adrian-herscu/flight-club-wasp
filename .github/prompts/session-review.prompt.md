...
- **instruction** — stable rule, applies repeatedly across sessions, expressible as a short constraint. Target: `.github/instructions/*.instructions.md` or `.github/copilot-instructions.md`.
- **skill** — repeatable multi-step workflow, operational runbook, or project-specific baselines with troubleshooting branches. Target: `.github/skills/*/SKILL.md`.
