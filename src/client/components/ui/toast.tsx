...
function ToastViewport({
  ...
  const positionClasses = position
    ...
    : "top-0 sm:bottom-0 sm:end-0 sm:top-auto";
...
function ToastClose({
  ...
  return (
    <ToastPrimitives.Close
      ...
      className={cn(
        "text-foreground/50 hover:text-foreground absolute inset-e-1 top-1 rounded-md p-1 opacity-0 transition-opacity focus:opacity-100 focus:outline-none focus:ring-1 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
        className
      )}
      toast-close=""
      {...props}
