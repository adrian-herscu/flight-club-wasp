...
| STD-REG-005 | FC-005 | Signed-in user can open student registration flow from the real role-selection path. | P0 | Gap | No active E2E currently selects STUDENT through the registration role selector and submits. |
