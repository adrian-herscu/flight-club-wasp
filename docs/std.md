...
| STD-PUB-003B | FC-001 | Authenticated user sees school-manager and assigned-instructor contact details on landing cards. | P0 | Covered | [04-01-public-discovery.spec.ts](../../e2e-tests/tests/04-01-public-discovery.spec.ts) — `logged in users can see schools and courses on landing` |
