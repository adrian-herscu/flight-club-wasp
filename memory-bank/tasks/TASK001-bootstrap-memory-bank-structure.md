...
| 1.4 | Adopt ongoing update workflow | In Progress | 2026-03-20 | Applied updates while implementing hourly-rate pricing baseline and removing legacy course default lesson price field |
...
### 2026-03-20
- Updated Memory Bank after implementing school/course hourly-rate baseline changes.
- Recorded schema, manager UI, operation fallback, and API test coverage updates for pricing model shift.
- Recorded follow-up cleanup that removes legacy `Course.defaultLessonPrice` from active schema and app logic in prototype mode.
